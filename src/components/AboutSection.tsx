      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12">
          <div className="comic-panel bg-comic-red relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 h-28 w-28 md:h-32 md:w-32 bg-comic-blue rounded-full flex items-center justify-center shadow-lg z-10">
