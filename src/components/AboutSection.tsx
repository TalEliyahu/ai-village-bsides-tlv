      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute -top-8 -left-6 h-28 w-28 md:h-32 md:w-32 bg-comic-red rounded-full flex items-center justify-center transform rotate-12 shadow-lg z-10">
          ...
          <div className="comic-panel bg-comic-yellow relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute -top-8 -right-6 h-28 w-28 md:h-32 md:w-32 bg-comic-blue rounded-full flex items-center justify-center transform -rotate-12 shadow-lg z-10">
          ...
          {/* VISION section */}
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute -top-8 -right-6 h-28 w-28 md:h-32 md:w-32 bg-comic-yellow rounded-full flex items-center justify-center transform -rotate-12 shadow-lg z-10">
        ...
        <div className="mt-12">
          <div className="comic-panel bg-comic-red relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300 border-4 border-comic-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)]">
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 h-32 w-32 md:h-36 md:w-36 bg-comic-yellow rounded-full flex items-center justify-center shadow-lg z-10 border-4 border-comic-black animate-pulse-bright">
              <span className="font-bangers text-comic-black text-3xl md:text-4xl text-center">🤝 JOIN US!</span>
            </div>
            <div className="pt-24 px-6 md:px-8 pb-6 md:pb-8">
              ...
              <div className="flex justify-center mt-8">
                <a 
                  href="https://bsidestlv.com/register" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="font-bangers text-xl md:text-2xl bg-comic-yellow text-comic-black px-8 py-3 rounded-lg border-3 border-comic-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.8)] hover:translate-y-1 hover:translate-x-1 transition-all duration-200"
                >
                  REGISTER NOW!
                </a>
              </div>
        ...
        <div className="mt-12">
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 h-28 w-28 md:h-32 md:w-32 bg-comic-yellow rounded-full flex items-center justify-center shadow-lg z-10">
              <span className="font-bangers text-comic-black text-2xl md:text-3xl text-center">💬 TOPICS</span>
            </div>
            <div className="pt-20 px-6 md:px-8 pb-6 md:pb-8">
              <h3 className="font-bangers text-2xl md:text-3xl text-comic-black mb-6 text-center">TOPICS WE'LL COVER</h3>
