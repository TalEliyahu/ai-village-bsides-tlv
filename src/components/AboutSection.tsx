...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-8 sm:py-12 px-4 sm:px-6 relative">
      <div className="max-w-6xl mx-auto">
        {/* Section title */}
        <div className="flex items-center justify-center mb-6 sm:mb-8">
          <div className="h-0.5 w-6 md:w-12 bg-comic-red"></div>
          <h2 className="font-bangers text-3xl md:text-5xl px-3 md:px-4 text-white comic-text-stroke">ABOUT THE VILLAGE</h2>
          <div className="h-0.5 w-6 md:w-12 bg-comic-red"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="bg-comic-red py-1 sm:py-2 text-center mb-2 sm:mb-4">
          ...
          <div className="comic-panel bg-comic-yellow relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="bg-comic-blue py-1 sm:py-2 text-center mb-2 sm:mb-4">
            ...
            <div className="px-4 md:px-6 pb-4 md:pb-6">
              ...
              <p className="text-comic-black font-comic text-base md:text-xl leading-relaxed mt-3 sm:mt-4">
          ...
          {/* VISION section */}
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="bg-comic-yellow py-1 sm:py-2 text-center mb-2 sm:mb-4">
        ...
        <div className="mt-6 sm:mt-8">
          <div className="comic-panel bg-comic-yellow relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300 border-4 border-comic-black shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)]">
            ...
            <div className="px-4 md:px-6 pb-4 md:pb-6">
              <div className="p-3 sm:p-4 rounded-lg bg-comic-white border-2 border-comic-black">
        ...
        <div className="mt-6 sm:mt-8">
          <div className="comic-panel bg-comic-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            <div className="bg-comic-yellow py-1 sm:py-2 text-center mb-2 sm:mb-4">
              <h3 className="font-bangers text-2xl sm:text-3xl text-comic-black">💬 TOPICS WE'LL COVER</h3>
            </div>
            <div className="px-4 md:px-6 pb-4 md:pb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 sm:gap-y-4 gap-x-4 sm:gap-x-6">
                <div className="flex items-start">
                  <CheckCircle className="text-comic-red flex-shrink-0 mt-1 mr-2 sm:mr-3" size={isMobile ? 18 : 22} />
