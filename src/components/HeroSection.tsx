...
const HeroSection = () => {
  return (
    <section className="relative min-h-[70vh] flex flex-col justify-center items-center px-4 sm:px-6 overflow-hidden pt-6 pb-4">
      ...
      <div className="relative z-10 text-center max-w-4xl">
        ...
        <div className="inline-block bg-comic-red p-2 sm:p-3 comic-border transform rotate-2 mb-3">
        ...
        <h1 className="font-luckiest text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-4 comic-text-stroke animate-skew">
        ...
        <div className="speech-bubble max-w-xs sm:max-w-sm md:max-w-lg mx-auto mb-2 animate-float">
